...
class UserMAB:
    ...
    def new_motif(self):
        ...
        elif self.targetFreq - self.freq + self.freq_tolerance < 0:         #On est en dessous de l'intervalle de tolerance
            if self.targetFreq - self.freq + self.freq_tolerance < -20:     #On est TRES en dessous de l'intervalle de tolerance
                self.motif = 0
            else:
                self.motif = 1

        elif self.targetFreq - self.freq - self.freq_tolerance > 0:         #On est au dessus de l'intervalle de tolerance
            if self.targetFreq - self.freq - self.freq_tolerance > 20:      #On est TRES au dessus de l'intervalle de tolerance
                self.motif = 4
            else:
                self.motif = 3
